...
function Connect4(p1, p2, gameId) 
{
        ...
        this.tokenState.forEach(function(item, idx, arr) {
            ...
            if (color != undefined) {
                ...
                if (item.player.remainingToWin === 0) {
                    console.log(item.player.name + " WINS!"); //the item here is twaits for god knows what reason.
                    winCondition = true;
                }
            }
    ...
    if (this.restoreGame()) {
        ...
        this.p1 = cached.p1;
        this.p2 = cached.p2;
        localStorage.clear(); //adding this here clears the last games. Works in SAFARI AND FIREFOX BUT NOT CHROME??
    }
